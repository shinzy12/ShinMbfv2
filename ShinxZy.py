...
\033[0;35m      ____         ____       [®]SHIN-MBF
\033[0;34m      |___         ___|       [®]UPDATE V1.2
\033[0;33m ________| S H I N |_________ [®]WESNGOPIORAHHHH
...
#    print (' Waktu : %s'%(datetime.now().strftime('%H:%M:%S'))
    ...
    print(" \033[0;36m[\033[0;35m+\033[0;36m]\033[0;32m Username  : %s "%(nama))
    print(" \033[0;36m[\033[0;35m+\033[0;36m]\033[0;33m User id   : %s "%(id))
